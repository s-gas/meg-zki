...
const About = () => {
  return (
    <div className="section" id="about">
      ...
      <p className="section-content">Lately, I’ve been exploring the world of data-driven, generative, and interactive installation design.</p>
      <p className="section-footer">Get in touch for full portfolio and availability.</p>
    </div>
  )
}
